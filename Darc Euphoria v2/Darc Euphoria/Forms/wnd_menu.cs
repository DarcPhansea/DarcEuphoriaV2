...
namespace Darc_Euphoria
{
    public partial class wnd_menu : Form
    {
        ...
        public double ConfigVersonNum = 2.112;
        ...
        public wnd_menu()
        {
            ...
            menu_cheats.Region =
                new Region(new RectangleF(tab_aimbot.Left, tab_aimbot.Top, tab_aimbot.Width, tab_aimbot.Height));
                ...
                Invoke((MethodInvoker) delegate
                {
                    try
                    {
                        if ((WinAPI.GetAsyncKeyState(0x2D) & 0x1) > 0)
                        {
                            Visible = !Visible;
                            gvar.isMenu = Visible;
                            if (gvar.OverlaySize.Width == 0)
                                gvar.OverlaySize = new Size(Screen.PrimaryScreen.WorkingArea.Width,
                                    Screen.PrimaryScreen.WorkingArea.Height);
                            Left = gvar.OverlayPoint.X + gvar.OverlaySize.Width / 2 - Width / 2;
                            Top = gvar.OverlayPoint.Y + gvar.OverlaySize.Height / 2 - Height / 2;
                        }
                    }
                    catch
                    {
        ...
        private void wnd_menu_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(
                    "Please exit using the exit button.\nThis ensures all threads are closed\nand that your computer wont be impacted.");
                e.Cancel = true;
            }
        }

        private void configs_btn_exit_Paint(object sender, PaintEventArgs e)
        {
            using (var brush = new SolidBrush(Color.FromArgb(26, 26, 26)))
            {
                var pointArr = new List<Point>();
                pointArr.Add(new Point(0, 0));
                pointArr.Add(new Point(0, configs_btn_exit.Height));
                pointArr.Add(new Point(configs_btn_exit.Width, configs_btn_exit.Height));
                e.Graphics.FillPolygon(brush, pointArr.ToArray(), FillMode.Winding);
            }
        }
        ...
        public void UpdateConfig(bool init)
        {
            ...
            Settings.userSettings.ConfigVersion = ConfigVersonNum;
            ...
            Settings.userSettings.VisualSettings.HealthPostion =
                (Settings.HealthDisplay) visuals_combox_healthDisplay.SelectedIndex;
            ...
            Settings.userSettings.MiscSettings.Radar = misc_chk_radarEnable.Checked;
            Settings.userSettings.MiscSettings.RadarSize = (int) misc_slider_radarSize.Value;
            Settings.userSettings.MiscSettings.RadarZoom = misc_slider_radarZoom.Value;

            Settings.userSettings.MiscSettings.BunnyHop = misc_chk_bunnyHop.Checked;
            Settings.userSettings.MiscSettings.BunnyHopChance = (int) misc_slider_bunnyHopChance.Value;
        ...
        public void UpdateClanChanger(bool init)
        {
            ...
            {
                Settings.userSettings.MiscSettings.ClanChangerTheme =
                    (Settings.ClanChangerTheme) misc_combox_clanChangerTheme.SelectedIndex;
        ...
        {
            var skin = new Settings._SkinSettings();
            if (init)
            {
                skin.Name = "";
                skin.SkinID = 1337;
            ...
            else
            {
                ...
                var skinEnum = Enum.GetNames(typeof(SKINID));

                var skinS = skin_list_skinList.SelectedIndex >= 0
                    ? skin_list_skinList.SelectedItem.ToString()
                    : string.Empty;
                if (skinS != string.Empty)
                    skin.SkinID = (int) (SKINID) Enum.Parse(typeof(SKINID), skinS);
            }
        ...
        public void UpdateColors(bool init)
        {
            if (init)
            {
                ...
                Settings.userSettings.VisualColors.Menu_Primary_Color = Color.FromArgb(255, 181, 62, 66);
            }
            else
            {
                ...
                {
                    case 0:
                        Settings.userSettings.VisualColors.Team_Box_Visible = euphColorPicker.SelectedColor;
                        break;
                    case 1:
                        Settings.userSettings.VisualColors.Team_Box_Hidden = euphColorPicker.SelectedColor;
                        break;
                    case 2:
                        Settings.userSettings.VisualColors.Team_Chams = euphColorPicker.SelectedColor;
                        break;
                    case 3:
                        Settings.userSettings.VisualColors.Team_Glow_Visible = euphColorPicker.SelectedColor;
                        break;
                    case 4:
                        Settings.userSettings.VisualColors.Team_Glow_Hidden = euphColorPicker.SelectedColor;
                        break;
                    case 5:
                        Settings.userSettings.VisualColors.Team_Snaplines_Visible = euphColorPicker.SelectedColor;
                        break;
                    case 6:
                        Settings.userSettings.VisualColors.Team_Snaplines_Hidden = euphColorPicker.SelectedColor;
                        break;
                    case 7:
                        Settings.userSettings.VisualColors.Team_Text = euphColorPicker.SelectedColor;
                        break;
                    case 8:
                        Settings.userSettings.VisualColors.Enemy_Box_Visible = euphColorPicker.SelectedColor;
                        break;
                    case 9:
                        Settings.userSettings.VisualColors.Enemy_Box_Hidden = euphColorPicker.SelectedColor;
                        break;
                    case 10:
                        Settings.userSettings.VisualColors.Enemy_Chams = euphColorPicker.SelectedColor;
                        break;
                    case 11:
                        Settings.userSettings.VisualColors.Enemy_Glow_Visible = euphColorPicker.SelectedColor;
                        break;
                    case 12:
                        Settings.userSettings.VisualColors.Enemy_Glow_Hidden = euphColorPicker.SelectedColor;
                        break;
                    case 13:
                        Settings.userSettings.VisualColors.Enemy_Snaplines_Visible = euphColorPicker.SelectedColor;
                        break;
                    case 14:
                        Settings.userSettings.VisualColors.Enemy_Snaplines_Hidden = euphColorPicker.SelectedColor;
                        break;
                    case 15:
                        Settings.userSettings.VisualColors.Enemy_Text = euphColorPicker.SelectedColor;
                        break;
                    case 16:
                        Settings.userSettings.VisualColors.World_Text = euphColorPicker.SelectedColor;
                        break;
                    case 17:
                        Settings.userSettings.VisualColors.Menu_Primary_Color = euphColorPicker.SelectedColor;
                        break;
                }
            }
        }
        ...
        public void SwitchColors(int i)
        {
            ...
            {
                case 0:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Box_Visible;
                    break;
                case 1:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Box_Hidden;
                    break;
                case 2:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Chams;
                    break;
                case 3:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Glow_Visible;
                    break;
                case 4:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Glow_Hidden;
                    break;
                case 5:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Snaplines_Visible;
                    break;
                case 6:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Snaplines_Hidden;
                    break;
                case 7:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Team_Text;
                    break;
                case 8:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Box_Visible;
                    break;
                case 9:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Box_Hidden;
                    break;
                case 10:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Chams;
                    break;
                case 11:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Glow_Visible;
                    break;
                case 12:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Glow_Hidden;
                    break;
                case 13:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Snaplines_Visible;
                    break;
                case 14:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Snaplines_Hidden;
                    break;
                case 15:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Enemy_Text;
                    break;
                case 16:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.World_Text;
                    break;
                case 17:
                    euphColorPicker.SelectedColor = Settings.userSettings.VisualColors.Menu_Primary_Color;
                    break;
            }
        }
        ...
        public void LoadConfig()
        {
            for (var i = 0; i < 10; i++)
            {
                Settings.userSettings =
                    configmaker.load<Settings.UserSettings>(
                        Application.StartupPath + configs_list_cheatCfg.SelectedItem);

                #region Aimbot

                aimbot_list_weaponCFG.SelectedIndex = 0;
                aimbot_chk_enable.Enabled = Settings.userSettings.AimbotSettings.Pistol.Enabled;
                aimbot_btn_key.Text = ((VirtualKeys) Settings.userSettings.AimbotSettings.Key).ToString();
                ...
                triggerbot_combox_mode.SelectedIndex =
                    (int) Settings.userSettings.TriggerbotSettings.Pistol.TriggerbotMode;
                ...
                misc_chk_radarEnable.Checked = Settings.userSettings.MiscSettings.Radar;
                misc_slider_radarSize.Value = Settings.userSettings.MiscSettings.RadarSize;
                misc_slider_radarZoom.Value = Settings.userSettings.MiscSettings.RadarZoom;
                misc_chk_bunnyHop.Checked = Settings.userSettings.MiscSettings.BunnyHop;
                misc_slider_bunnyHopChance.Value = Settings.userSettings.MiscSettings.BunnyHopChance;
                ...
                misc_btn_3rdpersonkey.Text =
                    ((VirtualKeys) Settings.userSettings.MiscSettings._3rdPersonKey).ToString();
                ...
                skin_btn_forceUpdate.Text = ((VirtualKeys) Settings.userSettings.ForceUpdateKey).ToString();
                UpdateColors(false);
            }
        }
        ...
        private readonly Thread aimbotThread = new Thread(Aimbot.Start)
        {
            Priority = ThreadPriority.Highest,
            IsBackground = true
        };

        private readonly Thread entityUpdate = new Thread(EntityList.Start)
        {
            Priority = ThreadPriority.Highest,
            IsBackground = true
        };

        private readonly Thread miscThread = new Thread(Misc.Start)
        {
            Priority = ThreadPriority.Highest,
            IsBackground = true
        };

        private readonly Thread fakeLagThread = new Thread(FakeLag.Start)
        {
            Priority = ThreadPriority.Highest,
            IsBackground = true
        };
        ...
        private readonly wnd_overlay overlay = new wnd_overlay();
        private wnd_Radar radar = new wnd_Radar();
        ...
        private void wnd_menu_Load(object sender, EventArgs e)
        {
            ...
            foreach (var c in controlList)
            {
                ...
                {
                    var cc = c as RadioButton;
                    cc.CheckedChanged += Cc_CheckedChanged;
                    cc.Paint += Master_Radio_Paint;
                }
            }
            ...
            var skinEnum = Enum.GetNames(typeof(SKINID));
            foreach (var skin in skinEnum) skin_list_skinList.Items.Add(skin);
            ...
            Left = rect.Right / 2 - Width / 2;
            Top = rect.Bottom / 2 - Height / 2;
        }
        ...
        private void List_DrawItem(object sender, DrawItemEventArgs e)
        {
            try
            {
                ...
                var selelected = (e.State & DrawItemState.Selected) == DrawItemState.Selected;
        ...
        private void cheatTabs_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                switch (tab.Text.ToLower())
                {
                    case "aimbot":
                        menu_cheats.SelectedIndex = 0;
                        break;
                    case "triggerbot":
                        menu_cheats.SelectedIndex = 1;
                        break;
                    case "visuals":
                        menu_cheats.SelectedIndex = 2;
                        break;
                    case "skins":
                        menu_cheats.SelectedIndex = 3;
                        break;
                    case "misc":
                        menu_cheats.SelectedIndex = 4;
                        break;
                    case "colors":
                        menu_cheats.SelectedIndex = 5;
                        break;
                    case "configs":
                        menu_cheats.SelectedIndex = 6;
                        break;
                }
        ...
        private void aimbot_list_weaponCFG_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    _Aimbot = Settings.userSettings.AimbotSettings.Pistol;
                    break;
                case 1:
                    _Aimbot = Settings.userSettings.AimbotSettings.Rifle;
                    break;
                case 2:
                    _Aimbot = Settings.userSettings.AimbotSettings.Smg;
                    break;
                case 3:
                    _Aimbot = Settings.userSettings.AimbotSettings.Sniper;
                    break;
                case 4:
                    _Aimbot = Settings.userSettings.AimbotSettings.Shotgun;
                    break;
                case 5:
                    _Aimbot = Settings.userSettings.AimbotSettings.Lmg;
                    break;
            }
        ...
        private void triggerbot_list_weaponCFG_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case 0:
                    _Triggerbot = Settings.userSettings.TriggerbotSettings.Pistol;
                    break;
                case 1:
                    _Triggerbot = Settings.userSettings.TriggerbotSettings.Rifle;
                    break;
                case 2:
                    _Triggerbot = Settings.userSettings.TriggerbotSettings.Smg;
                    break;
                case 3:
                    _Triggerbot = Settings.userSettings.TriggerbotSettings.Sniper;
                    break;
                case 4:
                    _Triggerbot = Settings.userSettings.TriggerbotSettings.Shotgun;
                    break;
                case 5:
                    _Triggerbot = Settings.userSettings.TriggerbotSettings.Lmg;
                    break;
            }
        ...
        {
            var s = Settings.userSettings.MiscSettings.NameChanger;
            UpdateClanChanger(false);
            if (Settings.userSettings.MiscSettings.ClanChangerTheme == Settings.ClanChangerTheme.Off)
                SetClanTag.Set("");

            if (Settings.userSettings.MiscSettings.NameChanger != string.Empty &&
                Settings.userSettings.MiscSettings.NameChanger != s)
        ...
        {
            UpdateColors(false);
            var col = Settings.userSettings.VisualColors.Menu_Primary_Color;
            lbl_CheatHeader.BackColor = col;
            label27.BackColor = col;
            label28.BackColor = col;
            label29.BackColor = col;
            configs_btn_exit.BackColor = col;
            ...
            foreach (var control in controlList)
            {
                ...
                {
                    var cc = control as Button;
                    cc.FlatAppearance.MouseDownBackColor = col;

                    if (cc.Name == "configs_btn_exit")
                    {
                        cc.FlatAppearance.MouseOverBackColor = Color.FromArgb(R, G, B);
                        cc.FlatAppearance.MouseDownBackColor = Color.FromArgb(R, G, B);
                    }
                }

                if (control.GetType() == typeof(ListBox)) control.Invalidate();

                if (control.GetType() == typeof(RadioButton))
                {
                    var cc = control as RadioButton;
                    cc.FlatAppearance.CheckedBackColor = col;
                    cc.FlatAppearance.MouseOverBackColor = Color.FromArgb(R, G, B);
                    cc.FlatAppearance.MouseDownBackColor = Color.FromArgb(R, G, B);
                }
            }
        ...
        private void aimbot_btn_key_Click(object sender, EventArgs e)
        {
            ...
            if (key == 0x1B)
            {
                Settings.userSettings.AimbotSettings.Key = 0;
                aimbot_btn_key.Text = "None";
            }
            else
            {
                ...
                aimbot_btn_key.Text = vkey.ToString();
        ...
        private void misc_btn_3rdpersonkey_Click(object sender, EventArgs e)
        {
            ...
            misc_btn_3rdpersonkey.Text = vkey.ToString();
        ...
        private void skins_btn_updateKey_Click(object sender, EventArgs e)
        {
            ...
            if (key == 0x1B)
            {
                Settings.userSettings.ForceUpdateKey = 0;
                skins_btn_updateKey.Text = "None";
            }
            else
            {
                var vkey = (VirtualKeys) key;

                skins_btn_updateKey.Text = vkey.ToString();
        ...
        private void skin_txt_skinSearch_KeyPress(object sender, KeyEventArgs e)
        {
            ...
            {
                var search = skin_txt_skinSearch.Text.ToLower();
                ...
                {
                    var skinname = skin.ToLower();
                    skinname = skinname.Replace("-", string.Empty);
                    skinname = skinname.Replace("_", string.Empty);
                    skinname = skinname.Replace(" ", string.Empty);

                    if (skinname.Contains(search)) skin_list_skinList.Items.Add(skin);
                }
            }
        }
        ...
        {
            if (configs_list_cheatCfg.SelectedIndex != -1)
        ...
        private void configs_btn_newCheat_Click(object sender, EventArgs e)
        {
        ...
        {
            if (configs_list_cheatCfg.SelectedIndex >= 0) LoadConfig();
        }
        ...
        private void configs_btn_newSkin_Click(object sender, EventArgs e)
        {
        ...
        {
            if (config_list_skinCfg.SelectedIndex != -1)
                Settings.userSkinSettings =
                    configmaker.load<Settings.SkinChanger>(Application.StartupPath + config_list_skinCfg.SelectedItem);
        }
