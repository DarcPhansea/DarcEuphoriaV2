namespace Darc_Euphoria.Euphoric.BspParsing
{
    public class BSPFlags
    {
        ...
        public const uint SURF_LIGHT = 0x0001;

        /// value will hold the light strength
        public const uint SURF_SLICK = 0x0002;

        /// effects game physics
        public const uint SURF_SKY = 0x0004;

        /// don't draw, but add to skybox
        public const uint SURF_WARP = 0x0008;

        /// turbulent water warp
        public const uint SURF_TRANS = 0x0010;

        public const uint SURF_WET = 0x0020;

        /// the surface is wet
        public const uint SURF_FLOWING = 0x0040;

        /// scroll towards angle
        public const uint SURF_NODRAW = 0x0080;

        /// don't bother referencing the texture
        public const uint SURF_Huint = 0x0100;

        /// make a primary bsp splitter
        public const uint SURF_SKIP = 0x0200;

        /// completely ignore, allowing non-closed brushes
        public const uint SURF_NOLIGHT = 0x0400;

        /// Don't calculate light
        public const uint SURF_BUMPLIGHT = 0x0800;

        /// calculate three lightmaps for the surface for bumpmapping
        public const uint SURF_HITBOX = 0x8000;

        /// surface is part of a hitbox
        public const uint CONTENTS_EMPTY = 0;

        /// No contents
        public const uint CONTENTS_SOLID = 0x1;

        /// an eye is never valid in a solid
        public const uint CONTENTS_WINDOW = 0x2;

        /// translucent, but not watery (glass)
        public const uint CONTENTS_AUX = 0x4;

        public const uint CONTENTS_GRATE = 0x8;
        ...
        public const uint CONTENTS_OPAQUE = 0x80;
        ...
        public const uint CONTENTS_MOVEABLE = 0x4000;
        ...
        public const uint CONTENTS_MONSTER = 0x2000000;
        ...
        public const uint CONTENTS_TRANSLUCENT = 0x10000000;

        /// uint set if any surface has trans
        public const uint CONTENTS_LADDER = 0x20000000;

        public const uint CONTENTS_HITBOX = 0x40000000;
        ...
        public const uint MASK_SOLID =
            CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_WINDOW | CONTENTS_MONSTER | CONTENTS_GRATE;

        /// everything that blocks player movement
        public const uint MASK_PLAYERSOLID = CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_PLAYERCLIP |
                                             CONTENTS_WINDOW | CONTENTS_MONSTER | CONTENTS_GRATE;

        /// blocks npc movement
        public const uint MASK_NPCSOLID = CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_MONSTERCLIP | CONTENTS_WINDOW |
        ...
        public const uint MASK_SHOT = CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_MONSTER | CONTENTS_WINDOW |
                                      CONTENTS_DEBRIS | CONTENTS_HITBOX;

        /// non-raycasted weapons see this as solid (includes grates)
        public const uint MASK_SHOT_HULL = CONTENTS_SOLID | CONTENTS_MOVEABLE | CONTENTS_MONSTER | CONTENTS_WINDOW |
