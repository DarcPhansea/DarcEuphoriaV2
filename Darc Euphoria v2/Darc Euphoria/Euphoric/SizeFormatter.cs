...
namespace Darc_Euphoria.Euphoric
{
    public static class SizeFormatter
    {
        ...
        private static readonly string[] NAMES_NUMBERS =
        {
            "", "Thousand", "Million", "Billion", "Trillion", "Quadrillion", "Quintillion", "Sextillion", "Septillion",
            "Octillion", "Nonillion"
        };

        private static readonly string[] NAMES_NUMBERS_ABBREVIATIONS = {"", "K", "M", "B", "T"};

        private static readonly string[] NAMES_SIZES =
            {"Byte", "Kilobyte", "Megabyte", "Gigabyte", "Terabyte", "Petabyte", "Exabyte", "Zettabyte", "Yottabyte"};

        private static readonly string[] NAMES_SIZESABBREVIATIONS =
        ...
        /// <returns></returns>
        public static string GetUnit(double value, long divider, string[] units, string format = FORMAT,
            int decimals = 2)
        {
            var idx = 0;
        ...
        {
            return GetUnit(value, DIVIDER_NUMBERS, useAbbreviation ? NAMES_NUMBERS_ABBREVIATIONS : NAMES_NUMBERS,
                format);
        }
