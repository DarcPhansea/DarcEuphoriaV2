...
namespace Darc_Euphoria
{
    public partial class wnd_menu : Form
    {
        ...
        public string ConfigVerson = "Darc Euphoria - Kurumi Build";
        ...
        public void UpdateSkinChanger(bool init)
        {
            ...
            else
            {
                ...
                if (skinS != String.Empty)
                    skin.SkinID = (int)((Enums.SKINID)Enum.Parse(typeof(Enums.SKINID), skinS));
            }
        ...
        public void LoadConfig()
        {
            for(int i = 0; i < 10; i++)
            {
                ...
                aimbot_btn_key.Text = ((Enums.VirtualKeys)Settings.userSettings.AimbotSettings.Key).ToString();
                ...
                misc_btn_3rdpersonkey.Text = ((Enums.VirtualKeys)Settings.userSettings.MiscSettings._3rdPersonKey).ToString();
                ...
                skin_btn_forceUpdate.Text = ((Enums.VirtualKeys)Settings.userSettings.ForceUpdateKey).ToString();
                UpdateColors(false);
            }
        }
        ...
        private void aimbot_btn_key_Click(object sender, EventArgs e)
        {
            ...
            Enums.VirtualKeys vkey = (Enums.VirtualKeys)key;
            ...
            while (true)
            {
                ...
                this.Invoke((MethodInvoker)delegate ()
                {
                    if ((WinAPI.GetAsyncKeyState(0x2D) & 0x1) > 0)
                    {
                        ...
                        {
                            gvar.OverlaySize = new Size(Screen.PrimaryScreen.WorkingArea.Width, Screen.PrimaryScreen.WorkingArea.Height);
                        }
                        this.Left = gvar.OverlayPoint.X + (gvar.OverlaySize.Width / 2) - (this.Width / 2);
                        this.Top = gvar.OverlayPoint.Y + (gvar.OverlaySize.Height / 2) - (this.Height / 2);
                    }
                });
            }
        }
